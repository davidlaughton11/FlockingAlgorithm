function agentPoints = assignAgentPoints(agentPositions, commCells, sides, partitions,rObs)
%% assignAgentPoints
...
allPoints = [reshape(X, [(sides*partitions)^2 1]) reshape(Y, [(sides*partitions)^2 1])]/partitions;
